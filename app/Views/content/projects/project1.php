...
<section class="blog" id="blog">
  <div class="container">
    <p class="section-subtitle"><?= $projectname ?? 'News & Blogs' ?></p>
    <!-- <h2 class="h2 section-title">Latest News Feeds</h2> -->
    <ul class="blog-list has-scrollbar">
      <li>
        <div class="blog-card">
          <figure class="card-banner">
            <img src="<?= base_url().'public/assets/images/blog-1.png' ?>" alt="The Most Inspiring Interior Design Of 2021" class="w-100">
          </figure>
          <div class="blog-content">
            <div class="blog-content-top">
              <h3 class="h3 blog-title"><a href="#">The Most Inspiring Interior Design Of 2021</a></h3>
            </div>
            <div class="blog-content-bottom">
              <div class="publish-date"><ion-icon name="calendar"></ion-icon><time datetime="2022-27-04">Apr 27, 2022</time></div>
      ...
      <li>
        <div class="blog-card">
          <figure class="card-banner">
            <img src="<?= base_url().'public/assets/images/blog-2.png' ?>" alt="The Most Inspiring Interior Design Of 2021" class="w-100">
          </figure>
          <div class="blog-content">
            <div class="blog-content-top">
              <h3 class="h3 blog-title"><a href="#">The Most Inspiring Interior Design Of 2021</a></h3>
